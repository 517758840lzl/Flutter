...
*
* Consumer2 可以关联两个以上的共享文件 Consumer3、Consumer4、Consumer5、Consumer6
* */
main() {
  runApp(
...
class showData3 extends StatelessWidget {
  const showData3({super.key});

  @override
  Widget build(BuildContext context) {
    return Consumer2<shareData,UserInfo>(builder: (context,value1,value2,child) {
      return Text("两个共享数据结合 ${value1.count},: ${value2.name}");
    });
  }
}
